...
from random import randint  # random pick user agents
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def __init__(self, settings) -> None:
        self.scrapeops_api_key = settings.get('SCRAPEOPS_API_KEY')  # get api key
        ...
        self.scrapeops_num_results = settings.get('SCRAPEOPS_NUM_RESULTS')  # number user agents you want
        self.headers_list = []
        self._get_user_agents_list()
        self._scrapeops_fake_user_agents_enabled()
    
    def _get_user_agents_list(self):
        """helper function to get all user agents"""
    ...
    def _get_random_user_agent(self):
        ...
        random_number = randint(0, len(self.user_agents_list)-1)
        return self.user_agents_list[random_number]
    ...
    def process_request(self, request, spider):
        """main function that will run the process request"""
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def _get_random_browser_header(self):
        """helper function to get random user agent"""      
        random_number = randint(0, len(self.headers_list)-1)
        return self.headers_list[random_number]
